...
QT_MOC_LITERAL(3, 24, 7), // "correct"
QT_MOC_LITERAL(4, 32, 3), // "New"
QT_MOC_LITERAL(5, 36, 5), // "error"
QT_MOC_LITERAL(6, 42, 10), // "exception*"
QT_MOC_LITERAL(7, 53, 1), // "e"
QT_MOC_LITERAL(8, 55, 11), // "buttonClick"
QT_MOC_LITERAL(9, 67, 16), // "QAbstractButton*"
QT_MOC_LITERAL(10, 84, 1), // "b"
QT_MOC_LITERAL(11, 86, 8) // "passHide"

    },
    "password_dialog\0result\0\0correct\0New\0"
    "error\0exception*\0e\0buttonClick\0"
    "QAbstractButton*\0b\0passHide"
};
...
void password_dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<password_dialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->result((*reinterpret_cast< bool(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 1: { int _r = _t->result((*reinterpret_cast< QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 2: { int _r = _t->error((*reinterpret_cast< exception*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 3: _t->buttonClick((*reinterpret_cast< QAbstractButton*(*)>(_a[1]))); break;
        case 4: _t->passHide((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = int (password_dialog::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&password_dialog::result)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = int (password_dialog::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&password_dialog::result)) {
                *result = 1;
                return;
            }
        ...
        {
            using _t = int (password_dialog::*)(exception * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&password_dialog::error)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
int password_dialog::result(bool _t1)
{
    int _t0{};
...
// SIGNAL 1
int password_dialog::result(QString _t1)
{
    int _t0{};
    void *_a[] = { const_cast<void*>(reinterpret_cast<const void*>(&_t0)), const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
int password_dialog::error(exception * _t1)
{
    int _t0{};
    void *_a[] = { const_cast<void*>(reinterpret_cast<const void*>(&_t0)), const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
