...
QT_MOC_LITERAL(3, 15, 22), // "search::search_struct*"
QT_MOC_LITERAL(4, 38, 12), // "eventCatcher"
QT_MOC_LITERAL(5, 51, 1), // "i"
QT_MOC_LITERAL(6, 53, 8), // "okButton"
QT_MOC_LITERAL(7, 62, 16), // "QAbstractButton*"
QT_MOC_LITERAL(8, 79, 1) // "b"

    },
    "search\0result\0\0search::search_struct*\0"
    "eventCatcher\0i\0okButton\0QAbstractButton*\0"
    "b"
};
...
void search::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->result((*reinterpret_cast< search::search_struct*(*)>(_a[1]))); break;
        case 1: _t->eventCatcher((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->okButton((*reinterpret_cast< QAbstractButton*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (search::*)(search::search_struct * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&search::result)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void search::result(search::search_struct * _t1)
{
